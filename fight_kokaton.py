...
class Bird:
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        #    False
        #)
        self.img = self.imgs[(+5, 0)]  #右向きコウカトンをデフォ画像にする
...
class Bomb:
    ...
    def __init__(self):
        ...
        color = random.choice(Bomb.colors)  # __class__
...
class Beam:
    ...
    def __init__(self, bird: Bird):
        ...
        self.rct = self.img.get_rect()
        self.rct.centery = bird.rct.centery  # コウカトンの画像取得
...
def main():
    ...
    while True:
        ...
        for beam in beams:  # 画面の範囲外に出たらリストから削除する
            if beam.rct.x < WIDTH:
                beam.update(screen)
